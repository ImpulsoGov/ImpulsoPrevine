...
describe('Login', () => {
  ...
  it('should login successfully (not using cypress testing library queries)', () => {
    const openModalButton = cy.contains('ACESSO RESTRITO');
  ...
  it('should login successfully (using cypress testing library queries)', () => {
