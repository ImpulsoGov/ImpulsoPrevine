...
test.describe("Navegação da tela de dados públicos", () => {
  test("Deve acessar a área aberta e renderizar todos os componentes", async ({ page }) => {
  ...
  test("Deve acessar a seção indicadores de desempenho e interagir com os gráficos", async ({ page }) => {
    await page.goto(`${BASE_URL}/analise`);
