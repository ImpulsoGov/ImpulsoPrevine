		...
		<ScoreCardGrid
			valores={[
				...
				},
				{
					...
					valor: tabelaDataAPS.reduce((acumulador, item) => {
						return item.id_status_usuario == 8 ? acumulador + 1 : acumulador;
					}, 0),
				},
				{
					descricao:
						"Total de gestantes sem DUM preenchida (inválidas para o Previne Brasil)",
					valor: tabelaDataAPS.reduce((acumulador, item) => {
						return item.id_status_usuario == 11 ? acumulador + 1 : acumulador;
					}, 0),
				},
			]}
		/>
