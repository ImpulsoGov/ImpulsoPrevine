    ...
    tabelaDataAPS ? (
        <ScoreCardGrid
            valores={[
                ...
                {
                    descricao:
                        "Total de pessoas com a coleta de citopatológico em dia",
                ...
                {
                    descricao:
                        "Total de pessoas com a coleta de citopatológico vencida (ou a vencer até o fim do quadrimestre)",
                    valor: tabelaDataAPS.reduce((acumulador, item) => {
                        return item.id_status_usuario == 15 ||
                            item.id_status_usuario == 16
                            ? acumulador + 1
                            : acumulador;
                    }, 0),
                },
                {
                    descricao:
                        "Coleta realizada antes dos 25 anos (Não contabilizada para o Previne Brasil)",
                    valor: tabelaDataAPS.reduce((acumulador, item) => {
