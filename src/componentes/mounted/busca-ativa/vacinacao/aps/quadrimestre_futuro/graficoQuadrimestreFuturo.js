...
const CardsGraficoAPSQuadrimestreFuturo = ({ tabelaDataAPS }) => {
    const dataQuadriFuturo = tabelaDataAPS?.filter(
        (item) => item.id_status_quadrimestre == 3,
    );
        ...
        <>
            <GraficoBuscaAtiva
                dataBarra={{
                    ...
                    color: ["#55D499", "#FFA75E", "#FF7C81", "#A6B5BE"],
                    grid: {
                        containLabel: true,
                        top: "20%",
                    },
