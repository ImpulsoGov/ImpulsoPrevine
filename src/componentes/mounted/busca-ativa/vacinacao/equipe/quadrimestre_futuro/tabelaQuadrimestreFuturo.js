...
const TabelaAPSQuadrimestreFuturo = ({
    ...
    const tabelaDataAPSVacinacao = tabelaDataAPS
        ?.filter((item) => item.id_status_quadrimestre == 3)
        ?.map((item) => ({
            ...item,
            datas_doses_polio: [
    ...
    if (tabelaDataAPSVacinacao[0]?.id_status_polio)
        tabelaDataAPSVacinacao.forEach(
            (item) =>
                (item.id_status_polio = codigosPolio[
    ...
    return tabelaDataAPS ? (
        <>
            ...
            >
                {proximosQuadrisFormatados && `${proximosQuadrisFormatados} -`}{" "}
                Crianças no período de vacinação
            </h2>
            <ScoreCardGrid
                valores={[
                    {
                    ...
                    },
                    {
                        ...
                        valor: tabelaDataAPSVacinacao.reduce(
                            (acumulador, item) => {
                    ...
                    },
                    {
                        ...
                        valor: tabelaDataAPSVacinacao.reduce(
                            (acumulador, item) => {
                                return item.id_status_polio == 30 ||
                                    item.id_status_penta == 3
                                    ? acumulador + 1
                                    : acumulador;
                            },
                    ...
                    },
                    {
                        ...
                        valor: tabelaDataAPSVacinacao.reduce(
                            (acumulador, item) => {
                                return item.id_status_polio == 40 &&
                                    item.id_status_penta == 4
                                    ? acumulador + 1
                                    : acumulador;
                            },
            ...
            <PainelBuscaAtiva
                ...
                filtrod_aplicados={filtros_aplicados}
