...
export const TabelaAPS = ({
	...
	const TabelaAPSTratada = tabelaDataAPS?.map((item) => ({
		...
		status_usuario:
			item.status_usuario == "Consulta e aferição de PA a fazer"
				? " Consulta e aferição de PA a fazer"
				: item.status_usuario,
	...
	return tabelaDataAPS && tabelaData ? (
		<PainelBuscaAtiva
			...
			dadosFiltros={[
				{
					data: [
						...new Set(TabelaAPSTratada.map((item) => item.equipe_nome_e_ine)),
					],
				...
				{
					data: [
						...new Set(TabelaAPSTratada.map((item) => item.acs_nome_cadastro)),
					],
					...
					data: [
						...new Set(
							TabelaAPSTratada.map(
								(item) => item.identificacao_condicao_hipertensao,
							),
						),
					],
				...
				{
					data: [
						...new Set(TabelaAPSTratada.map((item) => item.status_usuario)),
					],
				...
				},
				{
					data: [
						...new Set(
							TabelaAPSTratada.map((item) => item.cidadao_faixa_etaria),
						),
					],
