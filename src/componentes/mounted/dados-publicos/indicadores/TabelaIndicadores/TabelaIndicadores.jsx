...
const TabelaIndicadores = ({ TabIndicadores }) => {
    ...
    const NotaTooltip = () => (
        <div>
            <div
                className={`${styles.quadradoTooltip} ${styles.NotaRosa}`}
            ></div>
            &gt; 0 e &lt;= 5<br />
            <div
                className={`${styles.quadradoTooltip} ${styles.NotaLaranja}`}
            ></div>
            &gt; 5 e &lt;= 8<br />
            <div
                className={`${styles.quadradoTooltip} ${styles.NotaAmarela}`}
            ></div>
            &gt; 8 e &lt;= 9.9
            <br />
            <div
                className={`${styles.quadradoTooltip} ${styles.NotaVerde}`}
            ></div>
            = 10
        </div>
    );
    ...
    const colunas = useMemo(() => [
        ...
        },
        {
            ...
            headerAlign: "center",
            description:
                "Refere-se ao número de pessoas em dia com os critérios de consultas, procedimentos e exames e que contabilizaram neste quadrimestre.",
            headerClassName: styles.cabecalho,
        },
        {
            ...
            headerAlign: "center",
            description:
                "O denominador utilizado pode ser o informado (identificado) ou o estimado." +
        ...
        },
        {
            ...
            headerName: "Variação de desempenho de Q3-24/Q1-25",
            flex: 2,
            align: "center",
            headerAlign: "center",
            description:
    ...
    const ultimoPeriodo =
        TabIndicadores.length > 0
            ? TabIndicadores[TabIndicadores.length - 1].periodo_codigo
            : undefined;
