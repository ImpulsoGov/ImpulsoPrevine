...
export const Indicadores : React.FC<IndicadoresType>  = ({
  cidade,
}) => {
  ...
  return (
    <div style={{ margin: "0px 80px" }}>
      ...
      <Grid12Col
        items={[
          <div style={{ borderRight: '2px solid #ddd', paddingRight: '10px' }} key={1}>
            <TituloSmallTexto
              botao={{
                label: '',
                url: ''
      ...
      <TituloSmallTexto
        ...
        titulo="<b>Como melhorar o desempenho dos indicadores - 2024.Q3 </b>" tooltip="" />
