	...
	return (
		<div style={{ margin: "0px 80px" }}>
			...
			<Grid12Col
				items={[
					<div
						style={{ borderRight: "2px solid #ddd", paddingRight: "10px" }}
						key={1}
					>
						<TituloSmallTexto
							botao={{
						...
						/>
						<GraficoDesempenhoMunicipio GrafDesempenho={indicadoresData} />
					</div>,
					<div key={2}>
						<TituloSmallTexto
							botao={{
						...
						/>{" "}
						<GraficoHistoricoDesempenho GrafHistorico={indicadoresData} />
					</div>,
				]}
			/>
			<TituloSmallTexto
        ...
        **Equipes avaliadas: Equipes eSF, eAP, eCR, eAPP e eSFR ativas e credenciadas pelo Ministério da Saúde, cadastradas no SCNES pela gestão municipal, distrital ou estadual, homologadas pelo Ministério da Saúde e com ausência de irregularidades que justifiquem a suspensão de 100% (cem por cento) dos incentivos financeiros.</p>"
			...
			<TituloSmallTexto
				...
				titulo="<b>Como melhorar o desempenho dos indicadores - 2024.Q2 </b>"
				tooltip=""
			/>
