...
export const AcoesEstrategicas = ({ cidade }) => {
	...
	useEffect(() => {
		AcoesEstrategicasVigenteAgrupada(cidade).then((result) => {
	...
	return (
		<div style={{ margin: "0px 80px" }}>
			...
			<GraficoValorConsolidado GrafValorConsolidado={indicadoresDataGraf} />
			...
			<TabelaAcoesEstrategicas TabAcoes={indicadoresData} />
