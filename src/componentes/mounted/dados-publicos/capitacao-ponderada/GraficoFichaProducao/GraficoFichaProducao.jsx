			...
			<div className={styles.textContainer}>
				...
				<div className={`${styles.selectorBox} ${styles.AplicacaoSelector}`}>
					<div
						className={styles.selectorHeader}
						onClick={() =>
							setShowNovoCheckboxesaplicacao(!showNovoCheckboxesaplicacao)
						}
					>
						<span>Aplicação </span>
						<div className={styles.arrowIcon}>
									...
									<div key={index} className={styles.checkboxItem}>
										<label>
											<button
												className={styles.button}
												onClick={() =>
													handleExclusiveNovoCheckboxChangesapli(indicador)
												}
											>
												Apenas
											</button>
											<input
												...
												onChange={(e) =>
													handleNovoCheckboxChangeaplicacao(e.target.value)
												}
											/>
											{indicador}
										</label>
				...
				<div className={`${styles.selectorBox} ${styles.Validacaoelector}`}>
					<div
						className={styles.selectorHeader}
						onClick={() =>
							setShowNovoCheckboxesvalidacao(!showNovoCheckboxesvalidacao)
						}
					>
						<span>Validação </span>
						<div className={styles.arrowIcon}>
									...
									<div key={index} className={styles.checkboxItem}>
										<label>
											<button
												className={styles.button}
												onClick={() =>
													handleExclusiveNovoCheckboxChangesvalidacao(indicador)
												}
											>
												Apenas
											</button>
											<input
												...
												onChange={(e) =>
													handleNovoCheckboxChangevalidacao(e.target.value)
												}
											/>
											{indicador}
										</label>
