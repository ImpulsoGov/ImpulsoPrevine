...
const TabelaDesempenhoEquipesComSeletor = ({
	...
	const [showNovoCheckboxesequipe, setShowNovoCheckboxesequipe] =
		useState(false);
	const [showNovoCheckboxesperiodo, setShowNovoCheckboxesperiodo] =
		useState(false);
	...
	const handleNovoCheckboxChangeequipe = (value) => {
		...
		if (selectedNovoIndicadorequipe.includes(value)) {
			updatedSelectedNovoIndicadorequipe = selectedNovoIndicadorequipe.filter(
				(indicador) => indicador !== value,
			);
		} else {
	...
	const handleNovoCheckboxChangeperiodo = (value) => {
		...
		if (selectedNovoIndicadorperiodo.includes(value)) {
			updatedSelectedNovoIndicadorperiodo = selectedNovoIndicadorperiodo.filter(
				(indicador) => indicador !== value,
			);
		} else {
			...
			<div className={styles.textContainer}>
				...
				>
					<div
						...
						onClick={() => setShowNovoCheckboxescnes(!showNovoCheckboxescnes)}
					>
					...
					{showNovoCheckboxescnes && (
						<div className={styles.checkboxes}>
							<button className={styles.button} onClick={selectAllTeams}>
								Selecionar Todos
							</button>
							{selectedNovoIndicador
								.filter(
									(indicador, index, self) => self.indexOf(indicador) === index,
								)
								.map((indicador, index) => (
									<div key={index} className={styles.checkboxItem}>
										<label>
											<button
												...
												onClick={() =>
													handleExclusiveNovoCheckboxChangecnes(indicador)
												}
											>
												Apenas
											</button>
											<input
												...
												onChange={(e) =>
													handleNovoCheckboxChangecnes(e.target.value)
												}
											/>
											{indicador}
										</label>
								...
								.map((indicador, index) => (
									<div key={index} className={styles.checkboxItem}>
										<label>
											<button
												className={styles.button}
												onClick={() => handleExclusiveCheckboxChange(indicador)}
											>
												Apenas
											</button>
											<input
				...
				<div className={`${styles.selectorBox} ${styles.EquipeSelector}`}>
					<div
						className={styles.selectorHeader}
						onClick={() =>
							setShowNovoCheckboxesequipe(!showNovoCheckboxesequipe)
						}
					>
						<span>Equipe </span>
						<div className={styles.arrowIcon}>
									...
									<div key={index} className={styles.checkboxItem}>
										<label>
											<button
												className={styles.button}
												onClick={() =>
													handleExclusiveNovoCheckboxChangesequipe(indicador)
												}
											>
												Apenas
											</button>
											<input
												...
												onChange={(e) =>
													handleNovoCheckboxChangeequipe(e.target.value)
												}
											/>
											{indicador}
										</label>
				...
				<div className={`${styles.selectorBox} ${styles.PeriodoSelector}`}>
					<div
						className={styles.selectorHeader}
						onClick={() =>
							setShowNovoCheckboxesperiodo(!showNovoCheckboxesperiodo)
						}
					>
						<span>Período </span>
						<div className={styles.arrowIcon}>
									...
									<div key={index} className={styles.checkboxItem}>
										<label>
											<button
												className={styles.button}
												onClick={() =>
													handleExclusiveNovoCheckboxChangesperiodo(indicador)
												}
											>
												Apenas
											</button>
											<input
												...
												onChange={(e) =>
													handleNovoCheckboxChangeperiodo(e.target.value)
												}
											/>
											{indicador}
										</label>
...
const TabelaDesempenhoEquipes = ({ TabDesempenhos }) => {
	...
	const [selectedNovoIndicadorequipe, setSelectedNovoIndicadorequipe] =
		useState([...new Set(TabDesempenhos.map((item) => item.equipe_nome))]);

	const [selectedNovoIndicadorperiodo, setSelectedNovoIndicadorperiodo] =
		useState([...new Set(TabDesempenhos.map((item) => item.data_inicio))]);
