...
export const FooterMounted: React.FC<FooterMountedType> = ({
    ...
    return (
        <Footer
            ...
            socialMediaURLs={[
                {
                    url: res.socialMedias[0].url,
                    logo: res.socialMedias[0].logo[0].url,
                },
                {
                    url: res.socialMedias[1].url,
                    logo: res.socialMedias[1].logo[0].url,
                },
                {
                    url: res.socialMedias[2].url,
                    logo: res.socialMedias[2].logo[0].url,
                },
            ]}
        />
    );
