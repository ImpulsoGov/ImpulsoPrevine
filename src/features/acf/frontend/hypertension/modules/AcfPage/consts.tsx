...
export const textCoeq =
    "Acompanhe duas boas práticas definidas pelo Ministério da Saúde do indicador C5 de cuidado da pessoa com hipertensão de forma simples: visualizando a realização de consultas com profissional da saúde e aferição da pressão arterial. A lista mostra, com base nos registros da base local do município, como anda o cuidado das pessoas com hipertensão arterial vinculadas à sua equipe.";
