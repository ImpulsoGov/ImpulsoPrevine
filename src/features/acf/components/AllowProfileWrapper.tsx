...
export const AllowProfileWrapper = async ({
    searchParams, 
    session
}:{ 
    ...
    return AcfNominalListProps &&
            ...
            >
                <AcfNominalList props={AcfNominalListProps(externalCardsProps,params,tabID,subTabID)} />
            </AllowProfile>
