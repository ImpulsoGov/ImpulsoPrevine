'use client'
import { PreviewArtigoDestaque, ListaArtigos, TituloTexto, Spinner } from "@impulsogov/design-system"
    ...
    return (
        ...
        />
        {
          ...
          <ListaArtigos
              ...
              btn = {{label : artigosListaData.listaArtigos[0].buttonLabel , link: artigosListaData.listaArtigos[0].buttonLink}}
          /> : <Spinner/>
        }
        </>
    );
