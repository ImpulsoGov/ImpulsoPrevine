...
export const PainelComLegenda : React.FC<PainelComLegendaType> = ({ children }) => {
    return (
...
export const PainelComLegendaIndUm : React.FC<PainelComLegendaType> = ({ children }) => {
    return (
      <div style={{ margin: "0 80px 40px", backgroundColor: '#D7F2F6', padding: "30px 0", borderRadius:"10px", fontSize: "13px", paddingLeft: "30px"}}>
        {children}
        <div >
...
export const PainelComLegendaInd2e3 : React.FC<PainelComLegendaType> = ({ children }) => {
    return (
      <div style={{ margin: "0 80px 40px", backgroundColor: '#D7F2F6', padding: "30px 0", borderRadius:"10px", fontSize: "13px", paddingLeft: "30px"}}>
        {children}
        <div>
