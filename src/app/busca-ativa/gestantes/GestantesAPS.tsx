...
import { PainelComLegendaIndUm, PainelComLegendaInd2e3, PainelComLegenda } from "./PainelComLegenda";
...
export const GestantesAPS = ({
    ...
    const Children = [
        [
          [
            <CardsGraficoIndicadorUmQuadriAtual tabelaDataAPS={tabelaDataAPS} key="CardsGraficoIndicadorUmQuadriAtual"/>,
            <GraficoIndicadorUmQuadriAtual tabelaDataAPS={tabelaDataAPS} key="GraficoIndicadorUmQuadriAtual"/>,
          ],
          [
            <CardsGraficoIndicadorUmQuadriFuturo tabelaDataAPS={tabelaDataAPS} key="CardsGraficoIndicadorUmQuadriFuturo"/>,
            <GraficoIndicadorUmQuadriFuturo tabelaDataAPS={tabelaDataAPS} key="GraficoIndicadorUmQuadriFuturo"/>,
          ],
          [
            <IndicadorUmCardsGestantesAtivas tabelaDataAPS={tabelaDataAPS} key="IndicadorUmCardsGestantesAtivas"/>,
          ...
          [
            <IndicadorUmCardsGestantesEncerradas tabelaDataAPS={tabelaDataAPS} key="IndicadorUmCardsGestantesEncerradas"/>,
        ...
        [
          [
            <CardsGraficoIndicadorDoisQuadriAtual tabelaDataAPS={tabelaDataAPS} key="CardsGraficoIndicadorDoisQuadriAtual"/>,
            <GraficoIndicadorDoisQuadriAtual tabelaDataAPS={tabelaDataAPS} key="GraficoIndicadorDoisQuadriAtual"/>,
          ],
          [
            <CardsGraficoIndicadorDoisQuadriFuturo tabelaDataAPS={tabelaDataAPS} key="CardsGraficoIndicadorDoisQuadriFuturo"/>,
            <GraficoIndicadorDoisQuadriFuturo tabelaDataAPS={tabelaDataAPS} key="GraficoIndicadorDoisQuadriFuturo"/>,
          ],
          [
            <IndicadorDoisCardsGestantesAtivas tabelaDataAPS={tabelaDataAPS} key="IndicadorDoisCardsGestantesAtivas"/>,
          ...
          [
            <IndicadorDoisCardsGestantesEncerradas tabelaDataAPS={tabelaDataAPS} key="IndicadorDoisCardsGestantesEncerradas"/>,
        ...
        [
          [
            <CardsGraficoIndicadorTresQuadriAtual tabelaDataAPS={tabelaDataAPS} key="CardsGraficoIndicadorTresQuadriAtual"/>,
            <GraficoIndicadorTresQuadriAtual tabelaDataAPS={tabelaDataAPS} key="GraficoIndicadorTresQuadriAtual"/>,
          ],
          [
            <CardsGraficoIndicadorTresQuadriFuturo tabelaDataAPS={tabelaDataAPS} key="CardsGraficoIndicadorTresQuadriFuturo"/>,
            <GraficoIndicadorTresQuadriFuturo tabelaDataAPS={tabelaDataAPS} key="GraficoIndicadorTresQuadriFuturo"/>,
          ],
          [
            <IndicadorTresCardsGestantesAtivas tabelaDataAPS={tabelaDataAPS} key="IndicadorTresCardsGestantesAtivas"/>,
          ...
          [
            <IndicadorTresCardsGestantesEncerradas tabelaDataAPS={tabelaDataAPS} key="IndicadorTresCardsGestantesEncerradas"/>,
