...
export const VacinacaoAPS : React.FC<VacinacaoAPSProps> = ({
    ...
    const Children = [
        [
            [
              <CardsGraficoAPSQuadrimestreAtual tabelaDataAPS={tabelaDataAPS} key="CardsGraficoAPSQuadrimestreAtual"/>,
              <GraficoAPSQuadrimestreAtual tabelaDataAPS={tabelaDataAPS} key="GraficoAPSQuadrimestreAtual"/>,
            ],
            [
        ...
        [
          [
            <CardsGraficoAPSQuadrimestreProximo tabelaDataAPS={tabelaDataAPS} key="CardsGraficoAPSQuadrimestreProximo"/>,
            <GraficoAPSQuadrimestreProximo tabelaDataAPS={tabelaDataAPS} key="GraficoAPSQuadrimestreProximo"/>,
          ],
          [
      ...
      [
        [
          <CardsGraficoAPSQuadrimestreFuturo tabelaDataAPS={tabelaDataAPS} key="CardsGraficoAPSQuadrimestreFuturo"/>,
          <GraficoAPSQuadrimestreFuturo tabelaDataAPS={tabelaDataAPS} key="GraficoAPSQuadrimestreFuturo"/>,
        ],
        [
