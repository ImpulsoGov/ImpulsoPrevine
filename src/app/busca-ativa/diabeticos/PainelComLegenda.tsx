    ...
    return (
        ...
        >
            ...
            <div>
                ...
                <br />
                <p>
                    Autorreferido - a condição foi identificada como
                    “autorreferida” quando é relatada pelo usuário na realização
                    do Cadastro Individual.
                </p>
                <p>
                    Diagnóstico Clínico - a condição foi identificada como
