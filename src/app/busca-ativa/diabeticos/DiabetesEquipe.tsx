                ...
                <ScoreCardGrid
                    valores={[
                        ...
                        },
                        {
                            ...
                            valor: tabelaDataEquipe?.reduce(
                                (acumulador: any, item: any) => {
                                    return item.prazo_proxima_consulta ==
                                        "Em dia" &&
                                        item.prazo_proxima_solicitacao_hemoglobina ==
                                            "Em dia"
                                        ? acumulador + 1
                                        : acumulador;
                                },
                        ...
                        {
                            descricao:
                                "Total de pessoas com diagnóstico autorreferido",
                            valor: tabelaDataEquipe.reduce(
                                (acumulador: any, item: any) => {
                        ...
                        {
                            descricao:
                                "Total de pessoas com diagnóstico clínico",
                            valor: tabelaDataEquipe.reduce(
                                (acumulador: any, item: any) => {
                                    return item.identificacao_condicao_diabetes ==
                                        "Diagnóstico Clínico"
