...
export const Apoio : React.FC<ApoioProps>= ({
    res
}) => {
    return (
                        ...
                        <>
                          <Margem 
                            componente={
                              ...
                              <TituloSmallTexto
                                  key="passo1" botao={{label: '',url: ''}} imagem={{posicao: true, url: 'https://media.graphassets.com/RfAzQFuVRhsuaPFSaMHg'}}
                        ...
                        <>
                          <Margem 
                            componente={
                              ...
                              <TituloSmallTexto
                                  key="passo2" botao={{label: '',url: ''}} imagem={{posicao: null, url: ''}}
                        ...
                        <>
                          <Margem 
                            componente={
                              ...
                              <TituloSmallTexto
                                  key="passo3" botao={{label: '',url: ''}} imagem={{posicao: null, url: ''}}
                        ...
                        <>
                          <Margem 
                            componente={
                              ...
                              <TituloSmallTexto
                                  key="passo4" botao={{label: '',url: ''}} imagem={{posicao: null, url: ''}}
