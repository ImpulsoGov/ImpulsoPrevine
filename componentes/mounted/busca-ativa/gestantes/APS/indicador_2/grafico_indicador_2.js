...
const CardsGraficoIndicadorDois = ({tabelaDataAPS}) =>tabelaDataAPS ? <ScoreCardGrid
valores={[
    {
...
const GraficoIndicadorDois = ({tabelaDataAPS}) => tabelaDataAPS ? 
<>
    <h2 style={{
        marginTop : '30px',
        marginLeft : '120px',
...
export { GraficoIndicadorDois, CardsGraficoIndicadorDois }