...
const CardsGraficoIndicadorTres = ({tabelaDataAPS}) =>tabelaDataAPS ? <ScoreCardGrid
valores={[
    {
...
const GraficoIndicadorTres = ({tabelaDataAPS}) => tabelaDataAPS ? 
<>
    <h2 style={{
        marginTop : '30px',
        marginLeft : '120px',
...
export { GraficoIndicadorTres, CardsGraficoIndicadorTres }