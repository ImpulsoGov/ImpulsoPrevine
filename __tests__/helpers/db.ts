...
export const diabetesItem = (
    ...
    latestBloodPressureExamRequestDate: null,
    bloodPressureExamStatusByQuarter: 30,
    latestGlycatedHemoglobinExamRequestDate: null,
    glycatedHemoglobinExamStatusByQuarter: 10,
    latestFeetExamRequestDate: null,
    feetExamStatusByQuarter: 10,
    goodPracticesSum: 25,
