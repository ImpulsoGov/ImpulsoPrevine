...
describe(`/api/lista-nominal/hypertension/pages/coeq/[page] Route Handler`, () => {
    beforeEach(() => {
        jest.clearAllMocks();
        jest.resetModules();
    });
    ...
    describe(`POST /api/lista-nominal/hypertension/pages/coeq/[page]`, () => {
        it("Deve retornar 404 se a feature flag hypertensionNewProgram não estiver habilitada", async () => {
            ...
            const { POST } = await import(
                "@/app/api/lista-nominal/hypertension/pages/coeq/[page]/route"
            );
