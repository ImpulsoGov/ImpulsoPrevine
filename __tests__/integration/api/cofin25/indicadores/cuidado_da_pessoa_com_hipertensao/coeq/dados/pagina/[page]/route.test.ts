...
const coeqUrl = `http://localhost:3000/api/cofin25/indicadores/cuidado_da_pessoa_com_hipertensao/coeq/dados/pagina/0`;
const body = {
...
describe(`api/cofin25/indicadores/cuidado_da_pessoa_com_hipertensao/coeq/dados/pagina/[page] Route Handler`, () => {
    beforeEach(() => {
        jest.clearAllMocks();
        jest.resetModules();
    });
    ...
    describe(`POST api/cofin25/indicadores/cuidado_da_pessoa_com_hipertensao/coeq/dados/pagina/[page]`, () => {
        it("Deve retornar 404 se a feature flag hypertensionNewProgram não estiver habilitada", async () => {
            ...
            const { POST } = await import(
                "@/app/api/cofin25/indicadores/cuidado_da_pessoa_com_hipertensao/coeq/dados/pagina/[page]/route"
            );
