...
const coeqUrl =
    "http://localhost:3000/api/cofin25/indicadores/cuidado_da_pessoa_com_hipertensao/coeq/filtros";

describe("api/cofin25/indicadores/cuidado_da_pessoa_com_hipertensao/coeq/filtros Route Handler", () => {
    beforeEach(() => {
        jest.clearAllMocks();
        jest.resetModules();
    });
    ...
    describe("GET api/cofin25/indicadores/cuidado_da_pessoa_com_hipertensao/coeq/filtros", () => {
        it("Deve retornar 404 se a feature flag hypertensionNewProgram não estiver habilitada", async () => {
            ...
            const { GET } = await import(
                "@/app/api/cofin25/indicadores/cuidado_da_pessoa_com_hipertensao/coeq/filtros/route"
            );
