...
describe(`api/cofin25/indicadores/cuidado_da_pessoa_com_diabetes/coaps/dados/pagina/[page] Route Handler`, () => {
    beforeEach(() => {
        jest.clearAllMocks();
        jest.resetModules();
    });
    ...
    describe(`POST api/cofin25/indicadores/cuidado_da_pessoa_com_diabetes/coaps/dados/pagina/[page]`, () => {
        it("Deve retornar 404 se a feature flag diabetesNewProgram não estiver habilitada", async () => {
            ...
            const { POST } = await import(
                "@/app/api/cofin25/indicadores/cuidado_da_pessoa_com_diabetes/coaps/dados/pagina/[page]/route"
            );
