...
import { InicioAPSRequest } from "../../../src/services/inicio/inicioAPS";
import { InicioEquipeRequest } from "../../../src/services/inicio/inicioEquipe";
import { unificarSituacaoPorIndicadores } from "../../../src/helpers/inicio/unificarSituacaoPorIndicadores";
import { SessionProvider } from "next-auth/react";
import { PROFILE_ID } from "../../../src/types/profile";
...
jest.mock("../../../src/services/inicio/inicioAPS", () => ({
    InicioAPSRequest: jest.fn(),
}));

jest.mock("../../../src/services/inicio/inicioEquipe", () => ({
    InicioEquipeRequest: jest.fn(),
}));

jest.mock("../../../src/helpers/inicio/unificarSituacaoPorIndicadores", () => ({
